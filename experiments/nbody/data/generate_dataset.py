...
charged: python generate_dataset.py --simulation=charged --num-train=10000
gravity: python generate_dataset.py --simulation=gravity --num-train=10000 --n-balls=100
"""
import argparse
import time

import numpy as np
from synthetic_sim import ChargedParticlesSim, GravitySim
